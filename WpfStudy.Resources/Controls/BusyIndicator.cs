namespace WpfStudy.Resources.Controls
{
    ...
    public class BusyIndicator : Control
    {
        ...
        {
            this.Loaded += this.ControlBusyDecorator_Loaded;
        }
        ...
        private void ShowAdorner()
        {
            ...
            else
            {
                ...
                if (adornerLayer != null)
                {
                    ...
                    this.adorner.Cancel += (s1, e1) => { if (this.Cancel != null) { this.Cancel(s1, e1); } };
        ...
        public static void OnTextPropertyChangedCallback(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            ...
            if (self != null && self.adorner != null)
            {
        ...
        public static readonly DependencyProperty TextProperty =
            DependencyProperty.Register("Text", typeof(string), typeof(BusyIndicator), new UIPropertyMetadata(string.Empty, OnTextPropertyChangedCallback));
    ...
    public class BusyChrome : Control
    {
        public override void OnApplyTemplate()
        {
            ...
            var cancelButton = this.GetTemplateChild("PART_Cancel") as Button;
            if (cancelButton != null)
            {
                cancelButton.Click += new RoutedEventHandler(this.cancelButton_Click);
            }
            var msgText = this.GetTemplateChild("PART_Text") as Label;
            if (msgText != null)
            {
        ...
        {
            get { return (bool)this.GetValue(AllowCancelProperty); }
